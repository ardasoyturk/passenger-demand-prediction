...
# --------------------------------------------------
# 4. Create weekday-aware baseline averages
# --------------------------------------------------
...
company_route_time_weekday_table = (
    ...
    .rename(
        columns={
            "target": "company_route_time_weekday_prediction"
        }
    )
)
...
canonical_route_time_weekday_table = (
    ...
    .rename(
        columns={
            "target": "canonical_route_time_weekday_prediction"
        }
    )
)
...
print("\nWeekday-aware baseline results")
