...
const RELIABILITY = {
	NO_HISTORY: {
		label: 'Belirsiz tahmin',
		eyebrow: 'Geçmiş veri bulunamadı',
	...
	UNSAFE: {
		label: 'Güvenilmez tahmin',
		eyebrow: 'Yüksek belirsizlik',
	...
	LOW: {
		label: 'Temkinli değerlendirin',
		eyebrow: 'Sınırlı güven',
	...
	HIGH: {
		label: 'Güvenilir tahmin',
		eyebrow: 'Güçlü tarihsel destek',
